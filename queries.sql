...
--3
SELECT first_name, last_name, ROUND(AVG(price)) as average_price,  COUNT(owner_id) FROM owners o join vehicles v on o.id=v.owner_id GROUP BY (first_name, last_name) HAVING COUNT(owner_id) > 1
